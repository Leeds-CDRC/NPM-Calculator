...
shinyUI(fluidPage(theme = shinytheme("flatly"),
    ...
    navbarPage(title = "Nutrient Profile Model Calculator", id = "about",
               ...
               hr(),
               h2("Who is it for?"),
               p("The NPM Online Calculator is a quick, easy and transparent way to generate a product's NPM score, and check if it may be captured by HFSS legislation, supporting consistency among:"),
                                            ...
                                            tabsetPanel(type = "tabs", shinyjs::useShinyjs(), id ="calc1",
                                                        ...
                                                        tabPanel(title = "Enter product information", value = "calc",
                                                                 ...
                                                                 fluidRow(column(4,textInput("in_prodname", NULL, label = "Name", placeholder = "Product name")),
                                                                          ...
                                                                          column(4, p("Check if your product is in scope for HFSS legislation (optional)"),
               ...
               tabPanel("About", value = "Guide",
                        ...
                        tabsetPanel(type = "tabs",
                                    tabPanel(title = "Completing an assessment",
                                             ...
                                             tags$ul(tags$span(style ="color:teal","If the product is likely to be in scope for HFSS legislation")),
                                             br(),
                                    ...
                                    tabPanel(title ="The NPM",
                                             ...
                                             p("If a product scores 11 or more for A-points then it cannot score points for protein, unless it lso scores 5 points for fruit, vegetables and nuts."),
                                             ...
                                             hr(),
                                             p("Visit",tags$a(href="https://www.gov.uk/government/publications/the-nutrient-profiling-model","the NPM guidance"),"for full details, including specific gravity conversions applied by this tool"),
                                             ),
