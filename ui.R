               ...
               tabPanel(p("User guide", style = "font-size:20px;"), value = "Guide",
                        ...
                        tabsetPanel(type = "tabs",
                                    tabPanel(title = tags$b("Completing an assessment"),
                                             ...
                                             tags$ul(tags$span(style ="color:#166e6e","✓   The NPM score")),
                                             tags$ul(tags$span(style ="color:#166e6e","✓   If the product is likely to be in scope for",tags$a(href="https://www.legislation.gov.uk/uksi/2021/1368/contents/made","The Food (Promotion and Placement) (England) Regulations 2021", style="font-weight:bold")," which we dub 'HFSS legislation'")),
                                             br(),
                                             p(tags$b("To calculate the NPM score, all you need is:")),
                                             tags$ul(tags$span(style ="color:#166e6e","✓   Product nutrition information")),
                                             tags$ul(tags$span(style ="color:#166e6e","✓   Ingredients list")),
                                             tags$ul(tags$span(style ="color:#166e6e","✓   Our handy calculator")),
                                             br(),
                                             p(tags$b("To assess if a product is in scope for HFSS legislation:")),
                                             tags$ul(tags$span(style ="color:#166e6e","✓   You'll need to provide information about the product category")),),
                                             column(5,
                                             wellPanel(
                                              br(),
                                    ...
                                    tabPanel(title = tags$b("About the NPM"),
                                             ...
                                             tags$ul(tags$span(style ="color:#166e6e","Product advertising (on TV, online, on the Transport For London network and more)")),
                                             tags$ul(tags$span(style ="color:#166e6e","Product promotions in stores and online shopping platforms")),
                                             hr(),
                                    ...
                                    tabPanel(title = tags$b("About HFSS legislation"), 
                                             ...
                                             tags$ul(tags$span(style ="color:#166e6e","Falls into one of 13 categories")),
                                             tags$ul(tags$span(style ="color:#166e6e","Fails the UK NPM")),
